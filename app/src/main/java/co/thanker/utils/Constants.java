...
public class Constants {
    ...
    private static final String STRIPE_KEY = "pk_live_Vr6jM5nhEHguxB6r3L3d1m9b00HSQZkDgS";
     ...
     */
    public static final String PAYMENT_GATEWAY_TOKENIZATION_NAME = "paypal";
    ...
    public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS_NORMAL =
    ...
    public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS =
            new HashMap<String, String>() {{
                put("gateway", "paypal");
                put("gatewayMerchantId", "AdJMd3kfDjucSGXwfQMhc1HLNTYr5ih0SAcNXvARGFO5l1gv5wdLRgxhfpg6MN3JKhUecnD28hemRMIq");
                // Your processor may require additional parameters.
            }};

    public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS_WAYFORPAY =
            new HashMap<String, String>() {{
                put("gateway", "wayforpay");
                put("gatewayMerchantId", "2a9a8db1476e8742ef4b26fd6d5044a1b73bf718");
                // Your processor may require additional parameters.
            }};

    public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS_BLUESNAP =
            new HashMap<String, String>() {{
                put("gateway", "bluesnap");
                put("gatewayMerchantId", "814201");
                // Your processor may require additional parameters.
            }};

    public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS_GESTPAY =
            new HashMap<String, String>() {{
                put("gateway", "gestpay");
                put("gatewayMerchantId", "GESPAY80851");
                // Your processor may require additional parameters.
            }};

    public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_STRIPE_PARAMETERS =
            new HashMap<String, String>() {{
                put("gateway", "stripe");
                put("stripe-version", "2018-10-31");
                put("stripe:publishableKey", STRIPE_KEY);
                // Your processor may require additional parameters.
            }};
